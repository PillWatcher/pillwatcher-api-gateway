...
/**
 * Structure used to store patients
 */
@ApiModel(description = "Structure used to store patients")
@Validated
...
public class PatientDTOForGet extends ArrayList<PatientDTOForResponse>  {
  ...
  public String toString() {
    ...
    sb.append("class PatientDTOForGet {\n");
